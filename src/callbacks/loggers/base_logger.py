...
class BaseLogger:
    ...
    def write(self, epoch, train_log, train_batch, train_outputs, valid_log, valid_batch, valid_outputs, im_dim):
        ...
        self._add_images(epoch, train_batch, train_outputs, valid_batch, valid_outputs, im_dim)
