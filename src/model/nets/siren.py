...
class SIREN(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, hidden_layer_config=[],
                 omega_0=30, omega_w=None, delay_init=False):
        ...
        net.append(nn.Sequential(
            nn.Linear(self.in_features, hidden_layer_config[0]),
            SineLayer(self.w0)
        ))
        ...
        net.append(nn.Sequential(
            nn.Linear(hidden_layer_config[-1], self.out_features),
        ))
